...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function getVideoPoster(videoUrl) {
        if (videoUrl.includes("cloudinary.com")) {
            // buang fragment/query dulu sebelum ganti ekstensi (hindari salah tangkap regex)
            ...
            if (item.type === 'video') {
                ...
                card.innerHTML = `
                    ...
                    <div class="card-content">
                        ...
                        <p class="card-desc"><span>${item.desc}</span></p>
                    </div>
                `;
            } else {
                card.innerHTML = `
    ...
    // 6b. Klik teks kartu untuk reveal deskripsi
    ...
    if (jurnalGrid) {
        if (!JURNAL_CSV_URL || JURNAL_CSV_URL.includes("PASTE_LINK_CSV")) {
            ...
            jurnalGrid.innerHTML = '<div class="jurnal-loader"><span class="jurnal-loader-ring"></span><span class="jurnal-loader-text">Memuat Jurnal</span></div>';
